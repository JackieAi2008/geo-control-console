...
const TOUR_STEPS = [
  ...
  { phase: "C", chap: "第四章 · 行动与验证", view: "monitor", target: ["#curveBox"],
    title: "改了有没有用，看曲线说话",
    body: `双周跑一轮 14 问真实搜索（含 2 个区位词探针），答案侧点一下「<b>AI 代问</b>」——系统替你向豆包逐条提问并自动记入台账（元宝暂需人工抽查 2 条），系统自动画曲线。示例故事：8/24 基线几乎无人提及 → 8/28 部署百科稿和公众号一园一档 → 9/6 豆包、元宝开始提及，引用落在公众号与百科词条。曲线每点带样本量，起始数据自动锁定。` },
